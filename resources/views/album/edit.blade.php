...
<div class="card mt-4">
	<div class="card-body">
        ...
        <h5 class="card-title fw-bolder mb-3">Ubah Data Album</h5>

		<form method="post" action="{{ route('album.update', $data->id_album) }}">
			@csrf
            <div class="mb-3">
			...
			<div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama_album" name="nama_album" value="{{ $data->nama_album }}">
            </div>
            <div class="mb-3">
                <label for="harga_album" class="form-label">Harga</label>
                <input type="text" class="form-control" id="harga_album" name="harga_album" value="{{ $data->harga_album }}">
            </div>
            <div class="mb-3">
