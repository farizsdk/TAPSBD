        ...
        @foreach ($datas as $data)
            <tr>
                ...
                <td>
                    ...
                    <!-- Soft Delete -->
                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#softdeleteModal{{ $data->id_pembeli }}">
                        Sembunyikan
                    </button>

                    <!-- Modal -->
                    <div class="modal fade" id="softdeleteModal{{ $data->id_pembeli }}" tabindex="-1" aria-labelledby="softdeleteModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <form method="POST" action="{{ route('pembeli.softdelete', $data->id_pembeli) }}">
                                    @csrf
                                    <div class="modal-body">
                                        Apakah anda yakin ingin menghapus data ini?
                                    </div>
